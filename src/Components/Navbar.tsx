  ...
  return (
    <nav className="p-4 px-8  bg-slate-50 flex flex-row justify-between items-center">
      ...
      <div className="flex flex-row gap-8 ">
        ...
        <Link className="hover:text-pink-500 flex flex-row gap-2 justify-center items-center" to="/cart"><i className="fa-solid fa-cart-shopping"></i><h2>Cart {cart?.length}</h2></Link>
